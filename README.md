...
Along with exploring state-of-the-art CNN models for classification, our goal is to understand the challenges involved in piecing together a series of models designed to perform various tasks in a data processing pipeline.  Each model has its strengths and weaknesses, and engineering a real-world application often involves solving many problems without a perfect answer.
...
9. Switch [Keras backend](https://keras.io/backend/) to TensorFlow.
	...
	- __Windows__: 
		...
		install Opencv to your local syste```
...
```
jupyter notebook dog_breed_recognition.ipynb
Download/install opencv if it is not installed before.
```
